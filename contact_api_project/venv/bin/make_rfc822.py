#!/Users/macbookpro/LANDINGPAGE_ROYAL_INTEGRITY/royalIntegrity-send-email-web-app/contact_api_project/venv/bin/python3
# coding: utf-8
...
if __name__ == "__main__":
    ...
    parser.add_argument("--smtp-host", dest="smtp_host", default="127.0.0.1")
